...
describe("roundApply", () => {
  it("should apply all statements in a single round when no errors", async () => {
  ...
  it("should defer dependency errors and retry in next round", async () => {
    const statements: StatementEntry[] = [
  ...
  it("should report stuck when no progress can be made", async () => {
    const statements: StatementEntry[] = [
  ...
  it("should skip environment capability errors", async () => {
    const statements: StatementEntry[] = [
      {
        id: "ext",
  ...
  it("should report hard failures for non-dependency errors", async () => {
    const statements: StatementEntry[] = [
  ...
  it("should set check_function_bodies = off by default", async () => {
    const statements: StatementEntry[] = [
      { id: "1", sql: "CREATE SCHEMA test;" },
    ];
  ...
  it("should run final validation for functions when enabled", async () => {
    const statements: StatementEntry[] = [
      {
        id: "fn",
