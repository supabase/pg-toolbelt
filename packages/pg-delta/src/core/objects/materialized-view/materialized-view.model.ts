...
const ReplicaIdentitySchema = Schema.Literal("d", "n", "f", "i");

const materializedViewPropsSchema = Schema.mutable(
  Schema.Struct({
...
export type MaterializedViewProps = typeof materializedViewPropsSchema.Type;
