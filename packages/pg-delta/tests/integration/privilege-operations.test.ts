...
for (const pgVersion of POSTGRES_VERSIONS) {
  describe(`privilege operations (pg${pgVersion})`, () => {
    test(
      "object privileges on view (grant)",
    ...
    // GRANT tests
    test(
      "object privileges on table (grant)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "object privileges grant option addition (GRANT ... WITH GRANT OPTION)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "object privileges on table (revoke)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "object privileges grant option downgrade (REVOKE GRANT OPTION FOR)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "column privileges on table (grant)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "column privileges grant option addition",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "column privileges on table (revoke)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "column privileges grant option downgrade",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "default privileges in schema (revoke)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "role membership grant with admin option",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "role membership options update (admin off)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "object privileges with object creation (ordering)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "column privileges with object creation (ordering)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "default privileges with roles and schema creation (ordering)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "role membership after role creation (ordering)",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
