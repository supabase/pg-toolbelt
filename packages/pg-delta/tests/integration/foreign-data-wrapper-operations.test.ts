...
for (const pgVersion of POSTGRES_VERSIONS) {
  describe(`foreign-data-wrapper operations (pg${pgVersion})`, () => {
    test(
      "create foreign data wrapper basic",
    ...
    test(
      "create foreign data wrapper with options",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "create foreign data wrapper with multiple options",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "create server with type and version",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
    ...
    test(
      "create user mapping with options",
      withDbIsolated(pgVersion, async (db) => {
        await roundtripFidelityTest({
          mainSession: db.main,
          branchSession: db.branch,
