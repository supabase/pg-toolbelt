...
DO $$ BEGIN CREATE ROLE corpus_view_new_owner LOGIN; EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
ALTER VIEW test_schema.owned_view OWNER TO corpus_view_new_owner;
