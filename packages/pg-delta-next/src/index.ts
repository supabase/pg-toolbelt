...
export { encodeId, parseId, type StableId, type FactKind } from "./core/stable-id.ts";
export { canonicalize, contentHash, type Payload, type ContentHash } from "./core/hash.ts";
export {
  buildFactBase,
  FactBase,
  type Fact,
...
import { NotImplementedError } from "./core/diagnostic.ts";

/** Stage 7: SQL files → shadow DB → fact base. */
export function loadSqlFiles(): never {
  throw new NotImplementedError("loadSqlFiles (stage 7)");
}
