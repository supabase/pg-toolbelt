...
import { collectStatementsFromRoots, createRandomizedSingleFileFixture } from "./randomized-input";
...
export const expectRandomizedRuntimeOutcomeEnvelope = async (
  ...
  const { fixtureRoot, seeds, minStatementCount, initialMigrationSql } = options;
