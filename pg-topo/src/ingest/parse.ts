...
import { deparseSql, loadModule as loadPlpgsqlParserModule, parseSql } from "plpgsql-parser";
import { parseAnnotations } from "../annotations/parse-annotations.ts";
import type { AnnotationHints, Diagnostic, StatementId } from "../model/types.ts";
...
export const parseSqlFile = async (absolutePath: string): Promise<ParseFileResult> => {
